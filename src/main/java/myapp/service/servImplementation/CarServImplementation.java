package myapp.service.servImplementation;
...
public class CarServImplementation implements CarService {
    private List<Car> carList = new LinkedList<Car>();
    private static int id = 1;

    //    CarServiceImpl
    public CarServImplementation() {
        carList.add(
                new Car(id++,
                        "Aventador",
                        "Lamborghini",
                        "/img/car1.png",
                        "Aventador was originally manufactured by in 2013 by Lamborghini company, and is among the luxuroous and fastest cars on the planet",
                        1000000));
        carList.add(
                new Car(id++,
                        "Cefiro",
